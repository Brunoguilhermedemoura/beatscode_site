        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <div className="flex gap-3">
              <a
                href="https://www.facebook.com/beatscode"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Facebook"
                className="w-10 h-10 bg-white/5 flex items-center justify-center hover:bg-primary transition-colors"
              >
              ...
              <a
                href="https://www.instagram.com/beatscode"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/company/beatscode"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="w-10 h-10 bg-white/5 flex items-center justify-center hover:bg-primary transition-colors"
